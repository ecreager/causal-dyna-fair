...
def get_utility_curves_dempar(util, cdfs, group_size_ratio, scores):
    ...
    for i_a in range(scores.size):
        ...
        # NOTE: i_b is an index-threshold on group B under the DP constraint
        #       at selection rate prop_A
    ...
    for i_b in range(scores.size):
        ...
        # NOTE: i_a is an index-threshold on group A under the DP constraint
        #       at selection rate prop_B
